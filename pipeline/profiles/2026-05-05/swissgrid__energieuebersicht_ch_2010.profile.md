# Profil: energieuebersicht_ch_2010.xls

**Erstellt:** 2026-05-05T21:16:41
**Pfad:** `C:\Users\pelle\SynologyDrive\Docs\Studium\FHGR\Masterthesis\energy-viz\pipeline\raw\snapshots\2026-05-05\swissgrid\energieuebersicht_ch_2010.xls`
**Format:** XLS
...
| `Unnamed: 1` | datetime64[us] | 34 (97.14%) | 1 | 2014-05-23 14:14:26.127000 … 2014-05-23 14:14:26.127000 |
...
| Name | Typ | Nulls | Unique | Wertebereich / Beispiele |
|------|-----|-------|--------|--------------------------|
| `Unnamed: 0` | object | 0 (0.0%) | 35037 | `Zeitstempel`, `2010-01-01 00:15:00`, `2010-01-01 00:30:00` |
| `Summe endverbrauchte Energie Regelblock Schweiz | Total energy consumed by end users in the Swiss controlblock` | object | 0 (0.0%) | 35041 | `kWh`, `1608642.345`, `1593643.591` |
| `Summe produzierte Energie Regelblock Schweiz | Total energy production Swiss controlblock` | object | 0 (0.0%) | 35041 | `kWh`, `1415708.056`, `1394646.112` |
| `Summe verbrauchte Energie Regelblock Schweiz | Total energy consumption Swiss controlblock` | object | 0 (0.0%) | 35041 | `kWh`, `1786480.12525`, `1779847.27325` |
| `Netto Ausspeisung aus dem Übertragungsnetz Schweiz | Net outflow of the Swiss transmission grid` | object | 0 (0.0%) | 21023 | `kWh`, `380726.772`, `387720.615` |
| `Vertikale Einspeisung ins Übertragungsnetz Schweiz | Grid feed-in Swiss transmission grid` | object | 0 (0.0%) | 35038 | `kWh`, `1025705.319`, `994333.596` |
| `Positive Sekundär-Regelenergie | Positive secundary control energy` | object | 0 (0.0%) | 805 | `kWh`, `0`, `0` |
| `Negative Sekundär-Regelenergie | Negative secundary control energy` | object | 0 (0.0%) | 753 | `kWh`, `-12500`, `-34500` |
| `Positive Tertiär-Regelenergie | Positive tertiary control energy` | object | 0 (0.0%) | 88 | `kWh`, `0`, `0` |
| `Negative Tertiär-Regelenergie | Negative tertiary control energy` | object | 0 (0.0%) | 62 | `kWh`, `0`, `0` |
| `Verbundaustausch CH->AT | Cross Border Exchange CH->AT` | object | 0 (0.0%) | 328 | `kWh`, `0`, `0` |
| `Verbundaustausch AT->CH | Cross Border Exchange AT->CH` | object | 0 (0.0%) | 7158 | `kWh`, `223800`, `222200` |
| `Verbundaustausch CH->DE | Cross Border Exchange CH->DE` | object | 0 (0.0%) | 431 | `kWh`, `11000`, `16000` |
| `Verbundaustausch DE->CH | Cross Border Exchange DE->CH` | object | 0 (0.0%) | 877 | `kWh`, `336000`, `341000` |
| `Verbundaustausch CH->FR | Cross Border Exchange CH->FR` | object | 0 (0.0%) | 2426 | `kWh`, `13000`, `10000` |
| `Verbundaustausch FR->CH | Cross Border Exchange FR->CH` | object | 0 (0.0%) | 1928 | `kWh`, `240500`, `245500` |
| `Verbundaustausch CH->IT | Cross Border Exchange CH->IT` | object | 0 (0.0%) | 8047 | `kWh`, `384000`, `395000` |
| `Verbundaustausch IT->CH | Cross Border Exchange IT->CH` | object | 0 (0.0%) | 1721 | `kWh`, `0`, `0` |
| `Transit` | object | 0 (0.0%) | 12108 | `kWh`, `408000`, `421000` |
| `Import` | object | 0 (0.0%) | 17172 | `kWh`, `800300`, `808700` |
| `Export` | object | 0 (0.0%) | 8378 | `kWh`, `408000`, `421000` |
...
| Name | Typ | Nulls | Unique | Wertebereich / Beispiele |
|------|-----|-------|--------|--------------------------|
| `Unnamed: 0` | object | 0 (0.0%) | 8760 | `Zeitstempel`, `2010-01-01 01:00:00`, `2010-01-01 02:00:00` |
| `Vertikale Netzlast Übertragungsnetz Schweiz | Vertical load Swiss transmission grid` | object | 0 (0.0%) | 8761 | `MW`, `5588.306498`, `5633.298276` |
