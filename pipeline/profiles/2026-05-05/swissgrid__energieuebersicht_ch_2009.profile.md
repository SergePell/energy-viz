# Profil: energieuebersicht_ch_2009.xls

**Erstellt:** 2026-05-05T21:16:36
**Pfad:** `C:\Users\pelle\SynologyDrive\Docs\Studium\FHGR\Masterthesis\energy-viz\pipeline\raw\snapshots\2026-05-05\swissgrid\energieuebersicht_ch_2009.xls`
**Format:** XLS
...
|------|-----|-------|--------|--------------------------|
| `Energieübersicht Schweiz 2010` | str | 24 (68.57%) | 11 | `Anleitung`, `Ausgewählt / Selected:`, `Betrachtungszeitraum / Observation Period`, `Bis / To:`, `Das hier vorliegende Excel-Sheet beinhaltet die Gesamtübersicht der wichtigsten Eckdaten der Regelzone Schweiz.
...
| `Unnamed: 1` | datetime64[us] | 34 (97.14%) | 1 | 2014-05-23 14:14:55.032000 … 2014-05-23 14:14:55.032000 |
| `Unnamed: 2` | object | 31 (88.57%) | 3 | `1`, `DD`, `MW/MWh` |
| `Unnamed: 3` | object | 32 (91.43%) | 2 | `1`, `MM` |
| `Unnamed: 4` | object | 32 (91.43%) | 2 | `2010`, `YYYY` |
| `Unnamed: 5` | object | 32 (91.43%) | 3 | `0`, `1`, `hh` |
| `Unnamed: 6` | object | 32 (91.43%) | 2 | `0`, `min` |
| `Unnamed: 7` | datetime64[us] | 33 (94.29%) | 2 | 2010-01-01 00:00:00 … 2010-01-01 01:00:00 |
...
| `1.1` | float64 | 34 (97.14%) | 1 | 2.0 … 2.0 (mean 2.00) |
| `2010` | float64 | 35 (100.0%) | 0 |  |
...
| `2010-01-01 00:00:00` | object | 31 (88.57%) | 3 | `1`, `2010-01-01 01:00:00`, `M` |
...
| Name | Typ | Nulls | Unique | Wertebereich / Beispiele |
|------|-----|-------|--------|--------------------------|
| `Energieübersicht Schweiz 2010` | str | 93 (87.74%) | 13 | `Import/Export/Transit`, `Negative Sekundärregelenergie
...
| `Unnamed: 1` | str | 75 (70.75%) | 13 | `AT→CH`, `CH→AT`, `CH→DE`, `CH→FR`, `CH→IT`, … (+8) |
| `Unnamed: 2` | float64 | 96 (90.57%) | 8 | -12.5 … 5588.306498 (mean 1179.34) |
| `Unnamed: 3` | object | 73 (68.87%) | 11 | `-50`, `0`, `1522.907088`, `2010-01-01 00:00:00`, `4102.821276`, … (+6) |
| `Unnamed: 4` | float64 | 84 (79.25%) | 17 | 0.0 … 3201.2 (mean 641.95) |
| `Unnamed: 5` | float64 | 106 (100.0%) | 0 |  |
| `Unnamed: 6` | float64 | 106 (100.0%) | 0 |  |
| `Unnamed: 7` | str | 105 (99.06%) | 1 | `-` |
| `Unnamed: 8` | datetime64[us] | 105 (99.06%) | 1 | 2010-01-01 01:00:00 … 2010-01-01 01:00:00 |
| `Unnamed: 9` | float64 | 106 (100.0%) | 0 |  |
| `Unnamed: 10` | str | 64 (60.38%) | 2 | `MW`, `MWh` |
...
| Name | Typ | Nulls | Unique | Wertebereich / Beispiele |
|------|-----|-------|--------|--------------------------|
| `Unnamed: 0` | object | 0 (0.0%) | 35037 | `Zeitstempel`, `2009-01-01 00:15:00`, `2009-01-01 00:30:00` |
| `Summe endverbrauchte Energie Regelblock Schweiz | Total energy consumed by end users in the Swiss controlblock` | object | 0 (0.0%) | 35040 | `kWh`, `1829965.532`, `1715172.867` |
| `Summe produzierte Energie Regelblock Schweiz | Total energy production Swiss controlblock` | object | 0 (0.0%) | 35041 | `kWh`, `1328840.011`, `1310517.237` |
| `Summe verbrauchte Energie Regelblock Schweiz | Total energy consumption Swiss controlblock` | object | 0 (0.0%) | 35041 | `kWh`, `1923497.62025`, `1905593.89825` |
| `Netto Ausspeisung aus dem Übertragungsnetz Schweiz | Net outflow of the Swiss transmission grid` | object | 0 (0.0%) | 18231 | `kWh`, `535032.369`, `531262.971` |
| `Vertikale Einspeisung ins Übertragungsnetz Schweiz | Grid feed-in Swiss transmission grid` | object | 0 (0.0%) | 35040 | `kWh`, `1051663.768`, `1030932.571` |
| `Positive Sekundär-Regelenergie | Positive secundary control energy` | object | 0 (0.0%) | 698 | `kWh`, `0`, `0` |
| `Negative Sekundär-Regelenergie | Negative secundary control energy` | object | 0 (0.0%) | 775 | `kWh`, `-42000`, `-64000` |
| `Positive Tertiär-Regelenergie | Positive tertiary control energy` | object | 0 (0.0%) | 76 | `kWh`, `0`, `0` |
| `Negative Tertiär-Regelenergie | Negative tertiary control energy` | object | 0 (0.0%) | 183 | `kWh`, `0`, `0` |
| `Verbundaustausch CH->AT | Cross Border Exchange CH->AT` | object | 0 (0.0%) | 246 | `kWh`, `0`, `0` |
| `Verbundaustausch AT->CH | Cross Border Exchange AT->CH` | object | 0 (0.0%) | 7074 | `kWh`, `245700`, `234300` |
| `Verbundaustausch CH->DE | Cross Border Exchange CH->DE` | object | 0 (0.0%) | 436 | `kWh`, `9000`, `0` |
| `Verbundaustausch DE->CH | Cross Border Exchange DE->CH` | object | 0 (0.0%) | 866 | `kWh`, `563000`, `552000` |
| `Verbundaustausch CH->FR | Cross Border Exchange CH->FR` | object | 0 (0.0%) | 1848 | `kWh`, `95750`, `80750` |
| `Verbundaustausch FR->CH | Cross Border Exchange FR->CH` | object | 0 (0.0%) | 2218 | `kWh`, `313000`, `316000` |
| `Verbundaustausch CH->IT | Cross Border Exchange CH->IT` | object | 0 (0.0%) | 3751 | `kWh`, `479250`, `473250` |
| `Verbundaustausch IT->CH | Cross Border Exchange IT->CH` | object | 0 (0.0%) | 538 | `kWh`, `48750`, `41750` |
| `Transit` | object | 0 (0.0%) | 11388 | `kWh`, `584000`, `554000` |
| `Import` | object | 0 (0.0%) | 18404 | `kWh`, `1170450`, `1144050` |
| `Export` | object | 0 (0.0%) | 4290 | `kWh`, `584000`, `554000` |
...
| Name | Typ | Nulls | Unique | Wertebereich / Beispiele |
|------|-----|-------|--------|--------------------------|
| `Unnamed: 0` | object | 0 (0.0%) | 8760 | `Zeitstempel`, `2009-01-01 01:00:00`, `2009-01-01 02:00:00` |
| `Vertikale Netzlast Übertragungsnetz Schweiz | Vertical load Swiss transmission grid` | object | 0 (0.0%) | 8761 | `MW`, `6305.84352`, `6156.52985` |
